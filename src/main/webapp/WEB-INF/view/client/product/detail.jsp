                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <h5 style="font-family: Arial, Helvetica, sans-serif;" class="fw-bold mb-3"><fmt:formatNumber type = "number" value = "${product.price}"/>đ</h5>
                                    ...
                                    <ul class="list-unstyled fruite-categorie">
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Mackbook</a>
                                                <span>(3)</span>
                                            </div>
                                        </li>
                                        <li>
