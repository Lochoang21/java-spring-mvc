...
public class ItemController {
    ...
    public String handlePlaceOrder(
        ...
        User currentUser1 = new User();// null
        HttpSession session = request.getSession(false);
        long id = (long) session.getAttribute("id");
        currentUser1.setId(id);

        this.productService.handlePlaceOrder(currentUser1, session, receiverName, receiverAddress, receiverPhone);
